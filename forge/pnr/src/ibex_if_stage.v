module ibex_if_stage (
	...
	generate
		...
		if (BaseIsa == 32'sd1) begin : gen_cheriot_vio_regs
			...
			wire [1:1] sv2v_tmp_5AA2F;
			assign sv2v_tmp_5AA2F = 1'b0;
			always @(*) instr_fetch_cheriot_acc_vio_o = sv2v_tmp_5AA2F;
			wire [1:1] sv2v_tmp_C1FEE;
			assign sv2v_tmp_C1FEE = 1'b0;
			always @(*) instr_fetch_cheriot_bound_vio_o = sv2v_tmp_C1FEE;
		end
