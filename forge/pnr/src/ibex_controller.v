module ibex_controller (
	...
	generate
		if (BaseIsa == 32'sd1) begin : gen_update_regs_cheriot
			...
			wire [1:1] sv2v_tmp_A6134;
			assign sv2v_tmp_A6134 = 1'b0;
			always @(*) lsu_err_is_cheriot_q = sv2v_tmp_A6134;
			wire [1:1] sv2v_tmp_75EF9;
			assign sv2v_tmp_75EF9 = 1'b0;
			always @(*) cheriot_ex_err_q = sv2v_tmp_75EF9;
			wire [1:1] sv2v_tmp_A07B7;
			assign sv2v_tmp_A07B7 = 1'b0;
			always @(*) cheriot_wb_err_q = sv2v_tmp_A07B7;
			wire [1:1] sv2v_tmp_DD3BD;
			assign sv2v_tmp_DD3BD = 1'b0;
			always @(*) cheriot_asr_err_q = sv2v_tmp_DD3BD;
		end
	endgenerate
